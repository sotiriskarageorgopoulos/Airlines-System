        ...
        <div class="col-sm-4">
        	<%
        		...
        		if(request.getParameter("upd-datetime") != null) {
        			...
        			LocalDateTime depDateTime = LocalDateTime.parse(request.getParameter("timeOfDeparture"),formatter);
        			String param = "dep_datetime_update/"+flightNumber+"/"+String.valueOf(depDateTime);
        			WebResource webResource = client.resource(ENDPOINT_URL_DEPARTURE+param);
        			ClientResponse res = webResource.accept("text/plain").put(ClientResponse.class);
        		}
        	%>
        	<form method="POST" class="upd-form">
                 <h1 class="mt-3 del-header">Update Departure Time</h1>
